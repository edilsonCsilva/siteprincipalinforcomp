    ...
    <section class="container section-destaques back-light text-center margin-top-25">
        <div class="content margin-top-50">
            ...
            <section class="box box-3 back-dark-blue pdt-more">
                <a href="<?= BASE ?>/produtos" title="Veja Mais Produtos">
...
URL = "popup";
   ...
   window.open(URL,'popup', 'width='+width+', height='+height+', top='+top+', left='+left+', scrollbars=no, status=yes, toolbar=no, location=no, directories=no, menubar=no, resizable=no, fullscreen=no');
