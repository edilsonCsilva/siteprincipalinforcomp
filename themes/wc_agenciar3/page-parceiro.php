              ...
              <p class="tagline text-uppercase text-bold"><?= $page_subtitle; ?></p>
                ...
                <p style="color: red; margin-top: -21px; margin-bottom: 46px;"><b>*</b> Campos Obrigatórios</p>
                    ...
                    <div class="form-check">
                      ...
                      <br>
<label>
   <input class="form-check-input" type="checkbox" name="radio" value="Catraca" checked > Catraca <br>
   ...
   <input class="form-check-input" type="checkbox" name="radio4" value="Sensor de Vaga Livre" checked>Sensor de Vaga Livre<br>
   <input class="form-check-input" type="checkbox" name="radio5" value="Gestão de Canteiro de Obra com Catraca" checked>Gestão de Canteiro de Obra com Catraca<br>
