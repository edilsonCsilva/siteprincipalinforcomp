            ...
            <div class="nav-main text-right">
                <ul class="display-inline-block ul-none header_nav text-left">
                    ...
                    <li><a href="<?= BASE; ?>/contato" title="Contato" class="<?php
                        ...
                        ?>">Contato</a></li>
                         <li><a href="<?= BASE; ?>/parceiro" title="Parceiro" class="<?php
                        if ($URL[0] == 'Link'): echo 'active';
                        endif;
                        ?>">Seja Nosso Parceiro</a></li>    
                        
                        
                        
                              
                   
                    <li><a href="<?= BASE ?>/acesso-restrito" title="Acesso Restrito" style="color: #333!important; font-size: 1.1em;"><i class="icon-lock"></i></a></li>
