...
if (!$WorkControlDefineConf):
    ...
    if ($_SERVER ['SERVER_NAME'] == 'localhost'):
        define('BASE', 'http://localhost/wc_inforcomp'); //Url raiz do site
        define('THEME', 'wc_agenciar3'); //template do site
    else:
        define('BASE', 'https://www.agenciar3.com.br/dev/inforcomp'); //Url raiz do site
        define('THEME', 'wc_agenciar3'); //template do site
    endif;
endif;
...
if (!$WorkControlDefineConf):
     ...
     * ADMIN CONFIG
     */
    define('ADMIN_NAME', 'Gerenciador');  //Nome do painel de controle (Work Control)
    define('ADMIN_DESC', 'Gerenciador de Conteúdo para o Site!'); //Descrição do painel de controle (Work Control)
     ...
     * ACCOUNT CONFIG
     */
    define('ACC_MANAGER', 0); //Conta de usuários (UI)
    ...
    define('COMMENT_SEND_EMAIL', 0); //Envia e-mails transicionais para usuários sobre comentários
    ...
    define('EAD_TASK_SUPPORT_EMAIL', "danilo@agenciar3.com.br"); //Enviar alertas de novos tickets para?
