...
if ($_SERVER ['SERVER_NAME'] == 'localhost'):
    ...
    define('SIS_DB_HOST', 'mysql873.umbler.com'); //Link do banco de dados
    define('SIS_DB_USER', 'inforcomp'); //Usuário do banco de dados
    define('SIS_DB_PASS', 'V3N6b,,czo?|C'); //Senha  do banco de dados
    define('SIS_DB_DBSA', 'db_inforcomp'); //Nome  do banco de dados
endif;
/*
 * CACHE E CONFIG
...
define('DB_ALERT', 'ws_alert'); //Avisos
define('DB_HOMEPAGE', 'ws_homepage'); //Homepage
define('DB_ADICIONAL', 'ws_adicional'); //Adicional
